...
class AuthControllerTest {
  ...
  void signOutUser_shouldRevokeTokensAndClearCookie_whenValidTokens() throws Exception {
    ...
    when(jwtTokenProvider.getEmailFromAccessToken(accessToken)).thenReturn(email);
    ...
    verify(jwtTokenProvider).getEmailFromAccessToken(accessToken);
  ...
  void signOutUser_shouldStillWork_whenNoTokensProvided() throws Exception {
    ...
    verify(jwtTokenProvider, never()).getEmailFromAccessToken(anyString());
