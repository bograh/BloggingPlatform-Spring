...
public class CommentController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Comment successfully added", content = @Content(schema = @Schema(implementation = CommentResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Comments successfully retrieved", content = @Content(schema = @Schema(implementation = CommentResponse.class))),
            @ApiResponse(responseCode = "404", description = "Post not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    public ResponseEntity<ApiResponseGeneric<List<CommentResponse>>> getAllCommentsByPostId(
        ...
        ApiResponseGeneric<List<CommentResponse>> response = ApiResponseGeneric.success(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Comment successfully retrieved", content = @Content(schema = @Schema(implementation = CommentResponse.class))),
    ...
    public ResponseEntity<ApiResponseGeneric<CommentResponse>> getCommentById(
